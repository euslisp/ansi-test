...
(defskip read-suppress.13)
(defskip read-suppress.14)
(defskip read-suppress.15)
(defskip read-suppress.16)
...
(defskip read-suppress.sharp-left-paren.11)
(defskip read-suppress.sharp-left-paren.12)
...
(defskip read-suppress.sharp-c.1 "complex number")
(defskip read-suppress.sharp-c.2 "complex number")
(defskip read-suppress.sharp-c.3 "complex number")
(defskip read-suppress.sharp-c.4 "complex number")
(defskip read-suppress.sharp-c.5 "complex number")
(defskip read-suppress.sharp-c.6 "complex number")
(defskip read-suppress.sharp-c.7 "complex number")
(defskip read-suppress.sharp-c.8 "complex number")
(defskip read-suppress.sharp-c.9 "complex number")
(defskip read-suppress.sharp-c.10 "complex number")
(defskip read-suppress.sharp-c.11 "complex number")
(defskip read-suppress.sharp-c.12 "complex number")
(defskip read-suppress.sharp-c.13 "complex number")
(defskip read-suppress.sharp-c.14 "complex number")
(defskip read-suppress.sharp-c.15 "complex number")
...
(defskip read-suppress.sharp-s.1)
(defskip read-suppress.sharp-s.5)
(defskip read-suppress.sharp-s.6)
(defskip read-suppress.sharp-s.7)
(defskip read-suppress.sharp-s.8)
(defskip read-suppress.sharp-s.9)
